...
/- **MANUAL CODE**:
  Lemmas for translating between UInt8 <> U8.
  We don't put these with the other lemmas because we have to use them below. -/
...
def algorithms.aes.SBOX_body : Result (Array U8 256#usize) :=
  Result.ok ⟨sBoxUInt8.toList.map UInt8.toU8, sorry⟩

def algorithms.aes.INV_SBOX_body : Result (Array U8 256#usize) :=
  Result.ok ⟨invSBoxUInt8.toList.map UInt8.toU8, sorry⟩
...
/- [fips_implementations::algorithms::aes::expand_key_schedule_inner]:
   Source: 'src/algorithms/aes.rs', lines 97:0-109:1 -/
def algorithms.aes.expand_key_schedule_inner
  (w : alloc.vec.Vec U8) (nk : Usize) (i : Usize) (temp : Array U8 4#usize) :
  Result (alloc.vec.Vec U8)
  :=
  do
  let i1 ← i - nk
  let i2 ← i1 * 4#usize
  let i3 ←
    alloc.vec.Vec.index (core.slice.index.SliceIndexUsizeSliceTInst U8) w i2
  let i4 ← i - nk
  let i5 ← i4 * 4#usize
  let i6 ← i5 + 1#usize
  let i7 ←
    alloc.vec.Vec.index (core.slice.index.SliceIndexUsizeSliceTInst U8) w i6
  let i8 ← i - nk
  let i9 ← i8 * 4#usize
  let i10 ← i9 + 2#usize
  let i11 ←
    alloc.vec.Vec.index (core.slice.index.SliceIndexUsizeSliceTInst U8) w i10
  let i12 ← i - nk
  let i13 ← i12 * 4#usize
  let i14 ← i13 + 3#usize
  let i15 ←
    alloc.vec.Vec.index (core.slice.index.SliceIndexUsizeSliceTInst U8) w i14
  let i16 ← Array.index_usize temp 0#usize
  let i17 ←
    Array.index_usize (Array.make 4#usize [ i3, i7, i11, i15 ]) 0#usize
  let w1 ← alloc.vec.Vec.push w (i16 ^^^ i17)
  let i18 ← Array.index_usize temp 1#usize
  let i19 ←
    Array.index_usize (Array.make 4#usize [ i3, i7, i11, i15 ]) 1#usize
  let w2 ← alloc.vec.Vec.push w1 (i18 ^^^ i19)
  let i20 ← Array.index_usize temp 2#usize
  let i21 ←
    Array.index_usize (Array.make 4#usize [ i3, i7, i11, i15 ]) 2#usize
  let w3 ← alloc.vec.Vec.push w2 (i20 ^^^ i21)
  let i22 ← Array.index_usize temp 3#usize
  let i23 ←
    Array.index_usize (Array.make 4#usize [ i3, i7, i11, i15 ]) 3#usize
  alloc.vec.Vec.push w3 (i22 ^^^ i23)

/- [fips_implementations::algorithms::aes::expand_key_schedule]: loop 0:
   Source: 'src/algorithms/aes.rs', lines 114:4-126:5 -/
divergent def algorithms.aes.expand_key_schedule_loop
  ...
  then
    ...
    then
      ...
      let temp1 ← Array.update_usize temp 0#usize (i19 ^^^ i18)
      let w1 ← algorithms.aes.expand_key_schedule_inner w nk nk1 temp1
      let i20 ← nk1 + 1#usize
      algorithms.aes.expand_key_schedule_loop w1 nk total_words i20
    else
      if nk > 6#usize
      then
        do
        ...
        then
          ...
          let w1 ← algorithms.aes.expand_key_schedule_inner w nk nk1 temp
          let i17 ← nk1 + 1#usize
          algorithms.aes.expand_key_schedule_loop w1 nk total_words i17
        else
          do
          let w1 ←
            algorithms.aes.expand_key_schedule_inner w nk nk1
              (Array.make 4#usize [ i2, i6, i10, i14 ])
          let i17 ← nk1 + 1#usize
          algorithms.aes.expand_key_schedule_loop w1 nk total_words i17
      else
        do
        let w1 ←
          algorithms.aes.expand_key_schedule_inner w nk nk1
            (Array.make 4#usize [ i2, i6, i10, i14 ])
        let i16 ← nk1 + 1#usize
        algorithms.aes.expand_key_schedule_loop w1 nk total_words i16
  else Result.ok w

/- [fips_implementations::algorithms::aes::expand_key_schedule]:
   Source: 'src/algorithms/aes.rs', lines 112:0-127:1 -/
...
/- [fips_implementations::algorithms::aes::key_expansion]:
   Source: 'src/algorithms/aes.rs', lines 130:0-142:1 -/
...
/- [fips_implementations::algorithms::aes::sub_byte]:
   Source: 'src/algorithms/aes.rs', lines 145:0-147:1 -/
...
/- [fips_implementations::algorithms::aes::sub_bytes]: loop 0:
   Source: 'src/algorithms/aes.rs', lines 152:4-155:5 -/
...
/- [fips_implementations::algorithms::aes::sub_bytes]:
   Source: 'src/algorithms/aes.rs', lines 150:0-156:1 -/
...
/- [fips_implementations::algorithms::aes::inv_sub_byte]:
   Source: 'src/algorithms/aes.rs', lines 159:0-161:1 -/
...
/- [fips_implementations::algorithms::aes::inv_sub_bytes]: loop 0:
   Source: 'src/algorithms/aes.rs', lines 166:4-169:5 -/
...
/- [fips_implementations::algorithms::aes::inv_sub_bytes]:
   Source: 'src/algorithms/aes.rs', lines 164:0-170:1 -/
...
/- [fips_implementations::algorithms::aes::shift_rows]:
   Source: 'src/algorithms/aes.rs', lines 173:0-180:1 -/
...
/- [fips_implementations::algorithms::aes::inv_shift_rows]:
   Source: 'src/algorithms/aes.rs', lines 183:0-190:1 -/
...
/- [fips_implementations::algorithms::aes::mix_column]:
   Source: 'src/algorithms/aes.rs', lines 193:0-200:1 -/
...
/- [fips_implementations::algorithms::aes::inv_mix_column]:
   Source: 'src/algorithms/aes.rs', lines 203:0-210:1 -/
...
/- [fips_implementations::algorithms::aes::mix_columns]: loop 0:
   Source: 'src/algorithms/aes.rs', lines 216:4-229:5 -/
...
/- [fips_implementations::algorithms::aes::mix_columns]:
   Source: 'src/algorithms/aes.rs', lines 213:0-231:1 -/
...
/- [fips_implementations::algorithms::aes::inv_mix_columns]: loop 0:
   Source: 'src/algorithms/aes.rs', lines 237:4-250:5 -/
...
/- [fips_implementations::algorithms::aes::inv_mix_columns]:
   Source: 'src/algorithms/aes.rs', lines 234:0-252:1 -/
...
/- [fips_implementations::algorithms::aes::add_round_key]: loop 0:
   Source: 'src/algorithms/aes.rs', lines 258:4-261:5 -/
...
/- [fips_implementations::algorithms::aes::add_round_key]:
   Source: 'src/algorithms/aes.rs', lines 255:0-263:1 -/
...
/- [fips_implementations::algorithms::aes::extract_array_16]:
   Source: 'src/algorithms/aes.rs', lines 269:0-276:1 -/
...
/- [fips_implementations::algorithms::aes::cipher_loop]: loop 0:
   Source: 'src/algorithms/aes.rs', lines 283:4-289:5 -/
divergent def algorithms.aes.cipher_loop_loop
  (state : Array U8 16#usize) (key_schedule : Slice U8) (nr : Usize)
  (round : Usize) :
  Result (Array U8 16#usize)
  :=
  if round < nr
  then
    ...
    algorithms.aes.cipher_loop_loop state4 key_schedule nr round1
  else Result.ok state

/- [fips_implementations::algorithms::aes::cipher_loop]:
   Source: 'src/algorithms/aes.rs', lines 278:0-292:1 -/
def algorithms.aes.cipher_loop
  (state : Array U8 16#usize) (key_schedule : Slice U8) (nr : Usize) :
  Result (Array U8 16#usize)
  :=
  algorithms.aes.cipher_loop_loop state key_schedule nr 1#usize

/- [fips_implementations::algorithms::aes::cipher]:
   Source: 'src/algorithms/aes.rs', lines 295:0-305:1 -/
def algorithms.aes.cipher
  ...
  let state1 ← algorithms.aes.cipher_loop state key_schedule nr
  let (s, to_slice_mut_back) ← Array.to_slice_mut state1
  let s1 ← algorithms.aes.sub_bytes s
  let state2 := to_slice_mut_back s1
  let state3 ← algorithms.aes.shift_rows state2
  let i ← nr * 16#usize
  let a1 ← algorithms.aes.extract_array_16 key_schedule i
  algorithms.aes.add_round_key state3 a1

/- [fips_implementations::algorithms::aes::inv_cipher_loop]: loop 0:
   Source: 'src/algorithms/aes.rs', lines 312:4-319:5 -/
divergent def algorithms.aes.inv_cipher_loop_loop
  (state : Array U8 16#usize) (key_schedule : Slice U8) (nr : Usize)
  (round_idx : Usize) :
  Result (Array U8 16#usize)
  :=
  ...
  then
    ...
    algorithms.aes.inv_cipher_loop_loop state4 key_schedule nr round_idx1
  else Result.ok state

/- [fips_implementations::algorithms::aes::inv_cipher_loop]:
   Source: 'src/algorithms/aes.rs', lines 307:0-322:1 -/
def algorithms.aes.inv_cipher_loop
  (state : Array U8 16#usize) (key_schedule : Slice U8) (nr : Usize) :
  Result (Array U8 16#usize)
  :=
  algorithms.aes.inv_cipher_loop_loop state key_schedule nr 1#usize

/- [fips_implementations::algorithms::aes::inv_cipher]:
   Source: 'src/algorithms/aes.rs', lines 325:0-335:1 -/
def algorithms.aes.inv_cipher
  ...
  let a ← algorithms.aes.extract_array_16 key_schedule i
  let state ← algorithms.aes.add_round_key input a
  let state1 ← algorithms.aes.inv_cipher_loop state key_schedule nr
  let state2 ← algorithms.aes.inv_shift_rows state1
  let (s, to_slice_mut_back) ← Array.to_slice_mut state2
  let s1 ← algorithms.aes.inv_sub_bytes s
  let state3 := to_slice_mut_back s1
  let a1 ← algorithms.aes.extract_array_16 key_schedule 0#usize
  algorithms.aes.add_round_key state3 a1

/- [fips_implementations::algorithms::aes::aes128]:
   Source: 'src/algorithms/aes.rs', lines 338:0-343:1 -/
...
/- [fips_implementations::algorithms::aes::aes192]:
   Source: 'src/algorithms/aes.rs', lines 346:0-351:1 -/
...
/- [fips_implementations::algorithms::aes::aes256]:
   Source: 'src/algorithms/aes.rs', lines 354:0-359:1 -/
...
/- [fips_implementations::algorithms::aes::aes128_inv]:
   Source: 'src/algorithms/aes.rs', lines 362:0-367:1 -/
...
/- [fips_implementations::algorithms::aes::aes192_inv]:
   Source: 'src/algorithms/aes.rs', lines 370:0-375:1 -/
...
/- [fips_implementations::algorithms::aes::aes256_inv]:
   Source: 'src/algorithms/aes.rs', lines 378:0-383:1 -/
...
/- [fips_implementations::algorithms::sha1::{core::clone::Clone for fips_implementations::algorithms::sha1::u32x4}#2::clone]:
...
/- Trait implementation: [fips_implementations::algorithms::sha1::{core::clone::Clone for fips_implementations::algorithms::sha1::u32x4}#2]
   Source: 'src/algorithms/sha1.rs', lines 7:9-7:14 -/
@[reducible]
...
/- Trait implementation: [fips_implementations::algorithms::sha1::{core::marker::Copy for fips_implementations::algorithms::sha1::u32x4}#3]
...
/- [fips_implementations::algorithms::sha1::{core::ops::bit::BitXor<fips_implementations::algorithms::sha1::u32x4> for fips_implementations::algorithms::sha1::u32x4}#1::bitxor]:
...
/- Trait implementation: [fips_implementations::algorithms::sha1::{core::ops::bit::BitXor<fips_implementations::algorithms::sha1::u32x4> for fips_implementations::algorithms::sha1::u32x4}#1]
...
/- [fips_implementations::algorithms::sha1::INITIAL_STATE]
   Source: 'src/algorithms/sha1.rs', lines 38:0-38:93 -/
...
/- [fips_implementations::algorithms::sha1::CHUNK_SIZE]
   Source: 'src/algorithms/sha1.rs', lines 41:0-41:29 -/
...
/- [fips_implementations::algorithms::sha1::K0]
   Source: 'src/algorithms/sha1.rs', lines 44:0-44:30 -/
...
/- [fips_implementations::algorithms::sha1::K1]
   Source: 'src/algorithms/sha1.rs', lines 45:0-45:30 -/
...
/- [fips_implementations::algorithms::sha1::K2]
   Source: 'src/algorithms/sha1.rs', lines 46:0-46:30 -/
...
/- [fips_implementations::algorithms::sha1::K3]
   Source: 'src/algorithms/sha1.rs', lines 47:0-47:30 -/
...
/- [fips_implementations::algorithms::sha1::sha1msg1]:
   Source: 'src/algorithms/sha1.rs', lines 63:0-67:1 -/
...
/- [fips_implementations::algorithms::sha1::sha1msg2]:
   Source: 'src/algorithms/sha1.rs', lines 70:0-80:1 -/
...
/- [fips_implementations::algorithms::sha1::sha1_first_half]:
   Source: 'src/algorithms/sha1.rs', lines 84:0-86:1 -/
...
/- [fips_implementations::algorithms::sha1::sha1_digest_round_x4::K1V]
   Source: 'src/algorithms/sha1.rs', lines 92:4-92:45 -/
...
/- [fips_implementations::algorithms::sha1::sha1rnds4p]:
   Source: 'src/algorithms/sha1.rs', lines 145:0-181:1 -/
...
/- [fips_implementations::algorithms::sha1::sha1_digest_round_x4::K2V]
   Source: 'src/algorithms/sha1.rs', lines 93:4-93:45 -/
...
/- [fips_implementations::algorithms::sha1::sha1rnds4m]:
   Source: 'src/algorithms/sha1.rs', lines 184:0-220:1 -/
...
/- [fips_implementations::algorithms::sha1::sha1_digest_round_x4::K3V]
   Source: 'src/algorithms/sha1.rs', lines 94:4-94:45 -/
...
/- [fips_implementations::algorithms::sha1::sha1_digest_round_x4::K0V]
   Source: 'src/algorithms/sha1.rs', lines 91:4-91:45 -/
...
/- [fips_implementations::algorithms::sha1::sha1rnds4c]:
   Source: 'src/algorithms/sha1.rs', lines 106:0-142:1 -/
...
/- [fips_implementations::algorithms::sha1::sha1_digest_round_x4]:
   Source: 'src/algorithms/sha1.rs', lines 90:0-103:1 -/
def algorithms.sha1.sha1_digest_round_x4
  (abcd : algorithms.sha1.u32x4) (work : algorithms.sha1.u32x4) (i : U8) :
  Result algorithms.sha1.u32x4
  :=
  match i with
  | 0#scalar =>
...
/- [fips_implementations::algorithms::sha1::process_loop]: loop 0:
   Source: 'src/algorithms/sha1.rs', lines 226:4-234:5 -/
...
def algorithms.sha1.process_rounds_0
  ...
  let h1 ← algorithms.sha1.sha1_digest_round_x4 h0 ux 0#u8
  ...
  let h01 ← algorithms.sha1.sha1_digest_round_x4 h1 ux1 0#u8
  ...
  let h11 ← algorithms.sha1.sha1_digest_round_x4 h01 ux2 0#u8
  ...
  let h02 ← algorithms.sha1.sha1_digest_round_x4 h11 ux3 0#u8
  ...
  let h12 ← algorithms.sha1.sha1_digest_round_x4 h02 ux6 0#u8
...
def algorithms.sha1.process
  ...
  let args ← algorithms.sha1.process_rounds_0 (i, i1, i2, i3) state words
  let args1 ← algorithms.sha1.process_rounds_i args 1#u8
  let args2 ← algorithms.sha1.process_rounds_i args1 2#u8
  let t ← algorithms.sha1.process_rounds_i args2 3#u8
  let (h0, h1, _, _, _, _) := t
  let i4 ← algorithms.sha1.sha1_first h1
...
/- [fips_implementations::algorithms::sha1::chunkify]: loop 0:
   Source: 'src/algorithms/sha1.rs', lines 310:4-319:5 -/
...
/- [fips_implementations::algorithms::sha1::chunkify]:
   Source: 'src/algorithms/sha1.rs', lines 306:0-321:1 -/
...
/- [fips_implementations::algorithms::sha1::pad_message_loop]: loop 0:
   Source: 'src/algorithms/sha1.rs', lines 326:4-329:5 -/
...
/- [fips_implementations::algorithms::sha1::pad_message_loop]:
   Source: 'src/algorithms/sha1.rs', lines 324:0-330:1 -/
...
divergent def algorithms.sha1.hash_loop_loop
  ...
  then
    ...
    algorithms.sha1.hash_loop_loop chunks state1 chunk_index1
  else Result.ok state
...
def algorithms.sha1.hash (message : Slice U8) : Result (alloc.vec.Vec U8) :=
  ...
  let state ← algorithms.sha1.hash_loop chunks algorithms.sha1.INITIAL_STATE
  algorithms.sha1.hash_to_vec state
